    ...
    PhotoAnonymizer.prototype.identify = function() {
        var self = this,
            selectors = [
                ...
                'a[href^="/cap/people/show"] img',
                '.profile-image img',
                '#wvmp-results .entityblock a img',
                '#shared-profiles p img',
                '#topcard .module-body > img',
                '#callout-overlay td:first-child img',
                '.review-col .who img',
                '.shared-with ul li img',
                '.messages .template-owner img',
                '.inbox-preview-list .ip-pic img',
                '.inbox-pic img',
                '.owner img',
